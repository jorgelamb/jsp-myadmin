...
<body bgcolor="#f5f5f5">
           <img class="icon" src="./Images/logosml.png" alt="-" align="right"><br><br><br><br>
           <center>Best Viewed in 1280x800 resolution with Javascript Enabled Firefox 3.0 Browser. </center>
</body>
</html>